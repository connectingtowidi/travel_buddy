class ItineraryAttraction < ApplicationRecord
  ...
  def recommend_restaurants
    restaurant_recommendation_service = RestaurantRecommendationService.new(latitude: attraction.latitude, longitude: attraction.longitude, 
    dietary_requirements: itinerary.dietary_preferences)
  end
